...
export default async function RecognitionDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900 font-sans flex flex-col items-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl w-full bg-white border border-stone-200 rounded-lg shadow-sm p-8 md:p-12 flex flex-col gap-6">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
            ...
            {r.source_reference && (
              <div className="sm:col-span-2">
                ...
                <dd className="mt-1 text-stone-600 font-medium font-mono break-all">
                  {r.source_reference}
                </dd>
              </div>
            )}
