            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {filteredEditions.map((edition) => {
                ...
                return (
                  <div
                    key={edition.id}
                    className="bg-[#fcf8f2] border border-stone-beige rounded-lg overflow-hidden flex flex-col justify-between hover:border-muted-amber hover:shadow-sm transition-all duration-200"
                  >
                    <div>
                      {/* Tapa */}
                      {coverUrl ? (
                        ...
                        <div className="w-full h-72 bg-[#f2ede4] flex flex-col items-center justify-center text-stone-400 p-4 border-b border-stone-beige/70">
                          <svg className="w-12 h-12 text-stone-400/80 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                          </svg>
                          <span className="text-xs font-mono">Sin tapa</span>
